...
GDC_KBDDATA	.EQU	$60		; KBD CTLR DATA PORT
GDC_KBDST	.EQU	$64		; KBD CTLR STATUS/CMD PORT
;GDC_BASE	.EQU	$90		; GDC BASE I/O PORT
;GDC_DAC_BASE	.EQU	$98		; RAMDAC BASE I/O PORT
GDC_BASE        .EQU    $0              ; HD44680 LCD I/O PORT
#ENDIF
;
lcd_command     .equ GDC_BASE + $00     ;LCD command I/O port
lcd_data        .equ GDC_BASE + $01     ;LCD data I/O port
