...
Z180_IOWAIT	.SET	2		; Z180: I/O WAIT STATES TO ADD ABOVE 1 W/S BUILT-IN (0-3) ! djrm use 3 for LCD
;
...
;
LCDENABLE       .SET    TRUE	        ; Enable VFD Debug
LCDTERMENABLE   .SET    FALSE	        ; Enable VFD Terminal
;
...
;ASCISWAP	.SET	TRUE		; ASCI: SWAP CHANNELS
